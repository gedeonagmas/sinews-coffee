...
const ServiceDetails = () => {
  ...
  return (
    <Layout>
      <Breadcumb pageName={service?.serviceName} sub={"Service Details"} />
      {/*==================================================*/}
                              ...
                              <div key={i} className=" w-full ">
                                ...
                                >
                                  <Image
                                    ...
                                    alt={service?.serviceName || "Event Image"}
                                    fill
                                    className="border"
                                    objectFit="cover" // Ensures consistent aspect ratio
                                  />
                          ...
                          {services?.map((e, i) => {
                            return (
                              <li
                                ...
                                className={e?.id === service.id ? "active" : ""}
                              >
                                <Link
                                  legacyBehavior
                                  href={`/service-details?id=${e?.id}`}
                                >
                                  <a> {e?.serviceName} </a>
                                </Link>
                              </li>
